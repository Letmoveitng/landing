    ...
    return (
      <footer className="bg-black text-white w-full flex flex-col space-x-1">
        <div className="w-full flex max-md:flex-col-reverse justify-between px-15 max-md:px-5 pt-15  max-md:pt-10" data-bg="dark">
          <div className="max-w-max max-md:max-w-full flex max-md:flex-col space-y-8 space-x-15 max-md:space-y-0">
            <details className="max-md:w-full group md:open space-y-8 max-md:space-y-0">
              <summary
                className="
